...
<div class="form-group">
    ...
    @if (isset($book) && $book->cover)
        <div class="preview-container" id="preview-container">
            <img id="cover-preview" src="{{ asset('storage/covers/' . $book->cover) }}" alt="Cover Preview">
...
<div class="form-group">
    ...
    <textarea class="form-control text-font" id="description" name="description" rows="3"
        placeholder="Please enter a text containing a minimum of 150 characters and a maximum of 1000 characters" required>{{ old('description') ?? ($book->description ?? '') }}</textarea>
...
<div class="form-group">
    ...
    <input type="number" class="form-control" id="year" name="year" min="1800" max="{{ date('Y') }}"
